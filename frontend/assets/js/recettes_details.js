...
function displayRecettesSimilaire(meals, currentId) {
  divSimilaires.innerHTML = ""; //vide la div pour afficher de nouvelles recettes/mise à jour
  ...
  <div class="infoDetails">
    ...
    <div class="noteDetails">
      ...
      <div class="buttonDetails">
        <button type= "button" class="btnDetails" title="Ajouter aux favoris" aria-label="Ajouter aux favoris">
        ...
        <button type= "button" class="btnDetails" title ="Imprimer la recette" aria-label="Imprimer la recette">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Pro v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2025 Fonticons, Inc.-->

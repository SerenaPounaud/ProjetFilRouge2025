...
<section class="headerDetails">
  ...
  <div class="note">
    ${noteHtml}
    <button class="btnDetails" title="Ajouter aux favoris" style="background: transparent; border: none; padding: 0; cursor: pointer;">
    ...
    <button class="btnDetails" title ="Imprimer la recette" style="background: transparent; border: none; padding: 0; cursor: pointer;">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="50" height="50"><!--!Font Awesome Pro v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2025 Fonticons, Inc.-->
